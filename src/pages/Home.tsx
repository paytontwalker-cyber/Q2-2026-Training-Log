import { LayoutDashboard, Calendar, Dumbbell, LineChart, History as HistoryIcon, Download, UserCircle } from 'lucide-react';
...
export default function Home({ setCurrentPage }: { setCurrentPage: (page: any) => void }) {
  const navItems = [
    ...
    { id: 'export', label: 'Export', icon: Download, description: 'Export your workout data' },
  ...
  return (
    <div className="space-y-8 pb-20">
      <header>
        ...
        <p className="text-slate-500">What are you training today?</p>
      </header>
